...
gsea_results_df = read.table("../plotting_data/GSEA_REACTOME_analyais_results_LGG_GBM_STAD.txt", sep = "\t", header = T)
...
cancer = "LGG_GBM"
ecDNA_output_file = "../plotting_data/TCGA_LGG_GBM_LR_method_mean_ecDNA_predictions_nested_5_fold_200_repeat_on_predicted_ex_MLP_uni_stratified.csv"
...
patient_level_df = read.table("../plotting_data/CBTN_ecDNA_mean_predictions_from_brain_model_and_true_ecDNA_status.txt", header = T, sep = "\t")
...
CBTN_results_df = read.table( "../plotting_data/CBTN_ecDNA_predictions_and_amplicon_categories.txt", sep = "\t", header = T)
...
brain_model_corr_fn = "../plotting_data/TCGA_LGG_GBM.MLP_pred_coef_pvalue_per_gene.txt"
CBTN_corr_fn = "../plotting_data/CBTM.MLP_pred_on_LGG_GBM_coef_pvalue_per_gene.txt"
CBTN_corr_plotting_df = read.table("../plotting_data/CBTN_and_Brain_model_samples_gene_expression_correlations_by_category.txt", sep = "\t", header = T)
...
output_total_sample_numbers_df = read.table("../plotting_data/TCGA_LGG_GBM_STAD_ecDNA_predicted_sample_numbers.txt", sep = "\t", header = T)
...
true_ecDNA_labels_w_survival = read.table("../plotting_data/TCGA_LGG_true_ecDNA_labels_w_survival.txt", header = T, sep = "\t")
...
mean_predictions_df = read.table("../plotting_data/TCGA_LGG_ecDNA_predictions_for_unlabeled_samples.txt", header = T, sep = "\t")
...
all_predictions_df = read.table("../plotting_data/TCGA_unlabeled_LGG_GBM_STAD_predictions_for_survival_analysis.txt", sep = "\t", header = T)
hazard_ratios_df = read.table("../plotting_data/TCGA_unlabeled_LGG_GBM_STAD_hazard_ratios_for_survival_analysis.txt", sep = "\t", header = T)

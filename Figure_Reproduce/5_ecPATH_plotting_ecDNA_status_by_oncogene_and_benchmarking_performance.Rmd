...
EGFR_plotting_df = read.table("../plotting_data/ecDNA_predictions_by_EGFR_status.txt", header = T, sep = "\t")
CDK4_plotting_df = read.table("../plotting_data/ecDNA_predictions_by_CDK4_status.txt", header = T, sep = "\t")
MDM2_plotting_df = read.table("../plotting_data/ecDNA_predictions_by_MDM2_status.txt", header = T, sep = "\t")
ERBB2_plotting_df = read.table("../plotting_data/ecDNA_predictions_by_ERBB2_status.txt", header = T, sep = "\t")
...
all_cancer_perf_fn = "../plotting_data/Benchmarking_TCGA_ecDNA_predictions_by_model_all_performance_metrics.txt"
